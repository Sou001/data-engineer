...
def main(current_date = datetime.datetime.now().date()):
  ...
  tracks = Tracks.read("/home/simplon/airflow/spotify_playlist/sorties/"+f"tracks_{current_date.isoformat()}.csv")
  ...
  Artists.write(artists, "/home/simplon/airflow/spotify_playlist/sorties/"+f"artists_{current_date.isoformat()}.csv")
