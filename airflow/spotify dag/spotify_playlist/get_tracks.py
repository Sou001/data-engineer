...
def main(current_date = datetime.datetime.now().date()):
  ...
  filename = "/home/simplon/airflow/spotify_playlist/playlist.csv"
  with open(filename) as playlists:
    ...
    for playlist_id in playlists:
        ...
        Tracks.write(result, "/home/simplon/airflow/spotify_playlist/sorties/"+f"tracks_{current_date.isoformat()}.csv")
